    ...
    <div className="min-h-screen bg-[#020505] text-foreground flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-muted-foreground text-lg mb-10 leading-relaxed">
          We are Orion Edge Digital, a team passionate about creating elegant, calm, and highly functional tools for financial management. Our mission is to end the era of chaotic spreadsheets and bring clarity to your business and personal finances.
        </p>
