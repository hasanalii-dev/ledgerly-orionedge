    ...
    <div className="min-h-screen bg-[#020505] text-foreground flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-muted-foreground text-lg mb-10 leading-relaxed">
          The ultimate guide to mastering Lumen. Learn how to set up multiple planners, automate your workflows, and utilize advanced reporting features.
          Our full documentation portal is launching very soon.
        </p>
