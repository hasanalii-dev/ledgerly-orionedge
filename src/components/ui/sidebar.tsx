      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[18rem] !max-w-[18rem] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
    ...
    return (
      <main
        ...
        className={cn(
          ...
          "peer-data-[variant=inset]:min-h-svh md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow",
          className,
        )}
        {...props}
      />
