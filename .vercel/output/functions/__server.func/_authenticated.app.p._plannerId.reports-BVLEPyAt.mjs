...
import { G as ChevronDown, I as Download, V as Clock, X as Calendar, c as TrendingDown, n as Wallet, s as TrendingUp } from "./_libs/lucide-react.mjs";
...
import { t as Route } from "./_authenticated.app.p._plannerId.reports-AwGw0Res.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_authenticated.app.p._plannerId.reports-BVLEPyAt.js
...
function ReportsPage() {
	...
	const downloadCsv = () => {
		...
		a.href = url;
		a.download = `lumen-report-${format(/* @__PURE__ */ new Date(), "yyyy-MM-dd")}.csv`;
		a.click();
