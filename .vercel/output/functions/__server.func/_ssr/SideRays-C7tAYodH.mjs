...
//#region node_modules/.nitro/vite/services/ssr/assets/SideRays-C7tAYodH.js
...
var SideRays = ({ speed = 2.5, rayColor1 = "#EAB308", rayColor2 = "#96c8ff", intensity = 2, spread = 2, origin = "top-right", tilt = 0, saturation = 1.5, blend = .75, falloff = 1.6, opacity = 1, className = "" }) => {
