...
import { r as Users, rt as ArrowLeft } from "../_libs/lucide-react.mjs";
import { t as motion } from "../_libs/framer-motion.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/about-C0CPCLmh.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/10 via-background to-background z-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Users, { className: "h-10 w-10 text-primary" })
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "We are Orion Edge Digital, a team passionate about creating elegant, calm, and highly functional tools for financial management. Our mission is to end the era of chaotic spreadsheets and bring clarity to your business and personal finances."
				}),
