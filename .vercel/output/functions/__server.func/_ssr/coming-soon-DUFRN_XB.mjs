...
import { B as Construction, rt as ArrowLeft } from "../_libs/lucide-react.mjs";
import { t as motion } from "../_libs/framer-motion.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/coming-soon-DUFRN_XB.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/10 via-background to-background z-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Construction, { className: "h-10 w-10 text-primary" })
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "We are currently working hard to bring this page to life. Check back later for updates."
				}),
